...
import com.boviet.common.core.domain.entity.SysDept;
...
import com.boviet.system.service.ISysDeptService;
import com.boviet.system.service.ISysPostService;
import com.boviet.system.service.ISysRoleService;
...
public class SysUserController extends BaseController {
    ...
    public AjaxResult updateLanguage(@RequestBody SysUser user) {
    ...
    @PreAuthorize("@ss.hasPermi('system:user:list')")
    @GetMapping("/oracleTestUser")
    public TableDataInfo oracleTestUser(SysUser user) {
        List<SysUser> list = userService.oracleSelectUser(user);
        return getDataTable(list);
    }
